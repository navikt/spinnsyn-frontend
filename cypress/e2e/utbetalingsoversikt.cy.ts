...
describe('Tester visning av utbetalingsoversikt', () => {
    ...
    it('Forklaring', () => {
        cy.get('.utbetalingsoversikt .tekstinfo .navds-tag').should(
            'have.text',
            'Delvis\u00a0syk' + 'Helg'
        )

        cy.get('.utbetalingsoversikt .tekstinfo')
            .children('.navds-heading')
            .should('have.text', 'Forklaring')
        cy.get('.utbetalingsoversikt .tekstinfo')
    ...
    it('Sjekker utbetalingsoversikt på vedtak med alle dagtyper', () => {
        ...
        cy.get('.utbetalingsoversikt').within(() => {
            ...
            cy.contains('20.feb.')
                .parent()
                .parent()
                .should('contain', 'Ikke\u00a0medlem')
                .and('contain', '-')
            cy.contains('21.feb.')
                .parent()
                .parent()
                .should('contain', 'Etter\u00a0dødsfall')
                .and('contain', '-')
            cy.contains('22.feb.')
                .parent()
                .parent()
        ...
        cy.contains('Forklaring')
            .parent()
            .within(() => {
                cy.get('.navds-tag--small.navds-tag--info').contains(
                    'Arbeidsgiveren betaler'
                )
                cy.get(
                    '.navds-tag--small.navds-tag--info + .navds-body-short'
                ).contains(
                ...
                cy.get(
                    '.navds-tag--small.navds-tag--success + .navds-body-short'
                ).contains(
                ...
                cy.get('.navds-tag--small.navds-tag--success').contains(
                    'Delvis syk'
                )
                cy.get(
                    '.navds-tag--small.navds-tag--success + .navds-body-short'
                ...
                cy.get('.navds-tag--small.navds-tag--warning').contains(
                    'Fridag'
                )
                cy.get(
                    '.navds-tag--small.navds-tag--warning + .navds-body-short'
                ).contains(
