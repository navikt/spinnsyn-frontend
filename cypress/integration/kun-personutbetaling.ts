...
describe('Tester visning personutbetaling', () => {
    ...
    it('Viser info om utbetaling til person', () => {
        ...
        //
        cy.get('.ekspanderbartPanel__innhold .mer__inntekt__info > :nth-child(10)').contains('Totalbeløp')
        cy.get('.ekspanderbartPanel__innhold .mer__inntekt__info > :nth-child(11)').contains('Til slutt summerer vi alle dagene. Totalbeløp viser beregnet sykepenger før skatt og eventuelle andre påleggstrekk.')
