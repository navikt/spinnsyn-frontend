describe('Tester logikk i behandling.tsx', () => {
    ...
    it('Automatisk behandlet', () => {
        cy.visit('http://localhost:8080/syk/sykepenger/vedtak/4e044d03-2dfe-45e9-a904-77777777')
    ...
    it('Manuelt behandlet', () => {
        cy.visit('http://localhost:8080/syk/sykepenger/vedtak/99f389f2-0084-481b-bed8-47f6ac3491d4')
    ...
    it('Automatisk revurdert eller annullert', () => {
        cy.visit('http://localhost:8080/syk/sykepenger/vedtak/9ae82dd2-dcf1-4c16-9e12-35cb6d634337')
        cy.get('.behandling > .typo-undertittel').should('have.text', 'Automatisk behandling')
    ...
    it('Manuell revurdert eller annullert', () => {
        cy.visit('http://localhost:8080/syk/sykepenger/vedtak/9ae82dd2-dcf1-4c16-9e12-35cb6d634338')
        cy.get('.behandling > .typo-undertittel').should('have.text', 'Opplysningene')
