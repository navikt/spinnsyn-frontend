describe('Tester logikk i behandling.tsx', () => {
    ...
    it('Automatisk behandlet', () => {
        ...
        cy.get('.behandling').contains('Vi fattet vedtaket 23. oktober 2021. Opplysningene er hentet fra søknaden din, offentlige registre og inntektsmeldingen fra arbeidsgiveren din. Kontakt oss om du ønsker å se opplysningene.')
    ...
    it('Manuelt behandlet', () => {
        ...
        cy.get('.behandling').contains('Vi fattet vedtaket 12. april 2021. Opplysningene er hentet fra søknaden din, offentlige registre og inntektsmeldingen fra arbeidsgiveren din. Kontakt oss om du ønsker å se opplysningene.')
    ...
    it('Automatisk behandlet annullert vedtak', () => {
        ...
        cy.get('.behandling').contains('Vi fattet vedtaket 4. mai 2021. Opplysningene ble hentet fra søknaden din, offentlige registre og inntektsmeldingen fra arbeidsgiveren din. Kontakt oss om du ønsker å se opplysningene.')
    ...
    it('Manuelt behandlet revurdert vedtak', () => {
        ...
        cy.get('.behandling').contains('Vi fattet vedtaket 6. mai 2021. Opplysningene ble hentet fra søknaden din, offentlige registre og inntektsmeldingen fra arbeidsgiveren din. Kontakt oss om du ønsker å se opplysningene.')
