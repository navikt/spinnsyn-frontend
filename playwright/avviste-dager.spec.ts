...
test.describe('Avviste dager', () => {
    ...
    test('Vedtak med delvis godkjente utbetalingsdager', async ({ page }) => {
        ...
        const begrunnelseLink1 = refusjonsPanel.getByRole('link', { name: 'Se nærmere begrunnelse her' })
        await expect(begrunnelseLink1).toBeVisible()
        await begrunnelseLink1.click()
    ...
    test('Vedtak med avviste dager og ingen utbetaling', async ({ page }) => {
        ...
        const begrunnelseLink2 = ingenUtbetalingPanel.getByRole('link', { name: 'Se nærmere begrunnelse her' })
        await expect(begrunnelseLink2).toBeVisible()
        await begrunnelseLink2.click()
    ...
    test('Vedtak med delvisInnvilget begrunnelse fra Bømlo', async ({ page }) => {
        ...
        const begrunnelseLink3 = refusjonPanel.getByRole('link', { name: 'Se nærmere begrunnelse her' })
        await expect(begrunnelseLink3).toBeVisible()
        await begrunnelseLink3.click()
    ...
    test('Vedtak med avslag begrunnelse fra Bømlo', async ({ page }) => {
        ...
        const begrunnelseLink4 = ingenUtbetalingPanel.getByRole('link', { name: 'Se nærmere begrunnelse her' })
        await expect(begrunnelseLink4).toBeVisible()
        await begrunnelseLink4.click()
