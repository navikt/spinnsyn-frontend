...
export const EmojiButton = (props: EmojiButtonProps) => {
    ...
    return (
        <button
            ...
            className={cn(
                'rounded-xl flex flex-col items-center py-2 gap-y-2 text-ax-text-neutral w-[78px] h-[128px] hover:bg-ax-bg-neutral-soft',
                props.hoverColor,
                {
                    [`${props.hoverColor.split(':')[1]} bg-ax-bg-neutral-soft`]: isActive,
                },
            )}
