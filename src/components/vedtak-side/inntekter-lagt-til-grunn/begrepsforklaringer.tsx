...
export const Begrepsforklaringer = ({ vedtak, heltAvvist }: BeregningInfoProps) => {
    ...
    return (
        <ReadMore header="Begrepsforklaringer" open={open} onClick={onButtonClick} className="mt-4">
