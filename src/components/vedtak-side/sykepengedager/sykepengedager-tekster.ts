const SykepengedagerTekster = {
    ...
    'sykepengedager.sluttdato.tekst1': 'Datoen gjelder hvis du er sykmeldt uten opphold. Den vil flytte seg hvis du jobber i noen perioder, eller hvis du tar ferie.',
