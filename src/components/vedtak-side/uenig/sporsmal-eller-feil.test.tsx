...
describe('Spørsmål eller feil', () => {
    it('Viser lenke til inntektsmelding oversikt for arbeidstaker', async () => {
        ...
        expect(
            screen.getByText(/Hvis du vil se inntektsopplysningene arbeidsgiveren din har sendt inn/),
        ).toBeInTheDocument()
    ...
    it('Viser kontakt Nav tekst for arbeidstaker med InntektFraAOrdningenLagtTilGrunn', async () => {
        ...
        expect(
            screen.getByText(/Hvis du vil se opplysningene svaret er basert på, eller har andre spørsmål/),
        ).toBeInTheDocument()
