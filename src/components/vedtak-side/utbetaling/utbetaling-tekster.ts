const UtbetalingTekster = {
    ...
    'utbetaling.redusert6G.tekst': 'Du får du ikke sykepenger fra NAV for den delen av årsinntekten som er mer enn <a href="https://www.nav.no/no/nav-og-samfunn/kontakt-nav/utbetalinger/grunnbelopet-i-folketrygden" target="_blank">seks ganger grunnbeløpet.</a>',
