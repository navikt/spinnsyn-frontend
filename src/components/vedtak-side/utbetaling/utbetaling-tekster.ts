const UtbetalingTekster = {
    ...
    'utbetaling.person.trekk.heading':
        'Oppgitt beløp er før skatt, eventuelle kreditortrekk eller refusjonskrav fra kommunen.',
    'utbetaling.person.trekk.innhold':
        'Beløpet er før skatt, kreditortrekk og refusjonskrav fra kommunen. Kreditortrekk kan være fra kemneren, Statens innkrevingssentral eller NAV innkreving. Tilbakebetalingskrav fra kommunen kan være i forbindelse med sosialhjelp.',
