const UtbetalingTekster = {
    ...
    'utbetaling.sykepengegrunnlag.skjønn':
        'I noen saker må NAV fastsette sykepengegrunnlaget ved å bruke skjønn. Da ser en saksbehandler på saken din og vurderer hva som er det riktige sykepengegrunnlaget. ',
