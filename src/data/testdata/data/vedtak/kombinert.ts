...
export const kombinertDirekteOgRefusjon: RSVedtakWrapper = {
    ...
    daglisteArbeidsgiver: [
        { dato: '2021-02-04', dagtype: 'NavDag', begrunnelser: [], belop: 2455, grad: 100 },
    ...
    daglisteSykmeldt: [
        ...
        { dato: '2021-02-10', dagtype: 'NavDag', begrunnelser: [], belop: 2455, grad: 100 },
        { dato: '2021-02-11', dagtype: 'NavDag', begrunnelser: [], belop: 2455, grad: 100 },
        { dato: '2021-02-12', dagtype: 'NavDag', begrunnelser: [], belop: 2455, grad: 100 },
