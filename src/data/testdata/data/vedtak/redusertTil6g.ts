...
export const vedtakRedusertTil6G: RSVedtakWrapper = {
    ...
    daglisteArbeidsgiver: [
        { dato: '2021-10-18', dagtype: 'NavDag', begrunnelser: [], belop: 1964, grad: 80 },
        { dato: '2021-10-19', dagtype: 'NavDag', begrunnelser: [], belop: 1964, grad: 80 },
        { dato: '2021-10-20', dagtype: 'NavDag', begrunnelser: [], belop: 1964, grad: 80 },
        { dato: '2021-10-21', dagtype: 'NavDag', begrunnelser: [], belop: 1964, grad: 80 },
        { dato: '2021-10-22', dagtype: 'NavDag', begrunnelser: [], belop: 1964, grad: 80 },
