...
it('Sorterer gjeldende vedtak før revurderte i lista', () => {
    ...
    const gjeldende: RSVedtakWrapper = { id: '1', vedtak: { tom: '2020-06-13' }, revurdert: false } as any
...
it('Sorterer gjeldende vedtak før annullerte i lista', () => {
    ...
    const gjeldende: RSVedtakWrapper = { id: '1', vedtak: { tom: '2020-06-13' }, annullert: false } as any
