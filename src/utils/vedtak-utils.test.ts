...
describe('Tester estimering av sluttdato', () => {
    ...
    it('Neste uke på en fredag', () => {
        ...
        expect(
            fallbackEstimertSluttdato(mandagsVedtak).format('D. MMM YYYY')
        ).toEqual('12. Jun 2020')
    })
    ...
    it('Fredag til mandag', () => {
        ...
        expect(
            fallbackEstimertSluttdato(fredagsVedtak).format('D. MMM YYYY')
        ).toEqual('8. Jun 2020')
    })
    ...
    it('Siste dag var fredag, men tom er lørdag', () => {
        ...
        expect(
            fallbackEstimertSluttdato(lørdagsVedtak).format('D. MMM YYYY')
        ).toEqual('6. Jun 2020')
    })
